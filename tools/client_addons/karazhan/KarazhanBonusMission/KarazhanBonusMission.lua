...
local function SkinDialogueButton(button, label)
  ...
  button.bg:SetTexture(
    "Interface\\AddOns\\karazhan\\KarazhanBonusMission\\Art\\OptionBackground-Common.tga"
  )
  button.bg:SetAllPoints(button)

  button.hl = button:CreateTexture(nil, "HIGHLIGHT")
  button.hl:SetTexture(
    "Interface\\AddOns\\karazhan\\KarazhanBonusMission\\Art\\ButtonHighlight-Add.tga"
  )
...
KBM.parchment:SetTexture(
  "Interface\\AddOns\\karazhan\\KarazhanBonusMission\\Art\\bg_512x1024.tga"
)
