...
INSERT INTO `tmp_raid_reset_item`
SELECT * FROM `item_template` WHERE `entry` = 35704;
UPDATE `tmp_raid_reset_item`
SET `entry` = 950001,
    `name` = 'Naxxramas Reset Ticket',
    `description` = 'Use: Resets your Naxxramas raid lockouts.',
    `RequiredLevel` = 80,
    `bonding` = 1,
    `ScriptName` = 'item_raid_reset_ticket';
INSERT INTO `item_template`
SELECT * FROM `tmp_raid_reset_item`;
...
UPDATE `tmp_raid_reset_item`
SET `entry` = 950002,
    `name` = 'Obsidian Sanctum Reset Ticket',
...
UPDATE `tmp_raid_reset_item`
SET `entry` = 950003,
    `name` = 'Eye of Eternity Reset Ticket',
...
UPDATE `tmp_raid_reset_item`
SET `entry` = 950004,
    `name` = 'Vault of Archavon Reset Ticket',
...
UPDATE `tmp_raid_reset_item`
SET `entry` = 950006,
    `name` = 'Trial of the Crusader Reset Ticket',
...
UPDATE `tmp_raid_reset_item`
SET `entry` = 950008,
    `name` = 'Icecrown Citadel Reset Ticket',
...
UPDATE `tmp_raid_reset_item`
SET `entry` = 950009,
    `name` = 'Ruby Sanctum Reset Ticket',
...
(950001, 'koKR', '낙스라마스 초기화권',
 '사용 시 낙스라마스 공격대 귀속이 초기화됩니다.', 0),
(950002, 'koKR', '흑요석 성소 초기화권',
 '사용 시 흑요석 성소 공격대 귀속이 초기화됩니다.', 0),
(950003, 'koKR', '영원의 눈 초기화권',
 '사용 시 영원의 눈 공격대 귀속이 초기화됩니다.', 0),
(950004, 'koKR', '아카본 석실 초기화권',
 '사용 시 아카본 석실 공격대 귀속이 초기화됩니다.', 0),
(950005, 'koKR', '울두아르 초기화권',
 '사용 시 울두아르 공격대 귀속이 초기화됩니다.', 0),
(950006, 'koKR', '십자군의 시험장 초기화권',
 '사용 시 십자군의 시험장 공격대 귀속이 초기화됩니다.', 0),
(950007, 'koKR', '오닉시아의 둥지 초기화권',
 '사용 시 오닉시아의 둥지 공격대 귀속이 초기화됩니다.', 0),
(950008, 'koKR', '얼음왕관 성채 초기화권',
 '사용 시 얼음왕관 성채 공격대 귀속이 초기화됩니다.', 0),
(950009, 'koKR', '루비 성소 초기화권',
 '사용 시 루비 성소 공격대 귀속이 초기화됩니다.', 0);
