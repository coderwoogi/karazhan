...
INSERT INTO `solo_arena_stage` (
    ...
    `rank_s_seconds`, `rank_a_seconds`,
    `rank_b_seconds`, `rank_c_seconds`,
    `melee_target_gs`, `melee_health`, `melee_attack_power`,
    `melee_crit_pct`, `melee_armor_pen_rating`,
    `caster_target_gs`, `caster_health`, `caster_mana`, `caster_spell_power`,
